        ...
        return (
            <div>
                ...
                <div className="container">
                    <div>
                        <h1 className="h1 my-4">Obras Sociales</h1>
                    </div>

                    <div>
                        <button className='btn btn-primary rounded-pill px-4 text-white' onClick={() => { this.setState({ tipoModal: 'agregar' }); this.limpiarForm(); this.mostrarModal() }}><img src={suma} width="15px" className='me-2' />Agregar Obra Social</button>
                    </div>
                    <hr />
                    ...
                    <ModalBody>
                        <form className='form-group'>
                            <div className="border rounded p-2 mb-3">
                                ...
                                <input onChange={this.cambiosform} type="text" name="obrasocial" className='form-control mb-2' value={this.state.form.obrasocial} />
                ...
                <Modal isOpen={this.state.modalBorrar}>
                    <ModalBody>
                        ...
                        <h4 className="h5 text-center-py-4">¿Está seguro de que desea eliminar? a: <br /> <strong>{this.state.form.obrasocial}  </strong> </h4>
                ...
                <Modal isOpen={this.state.modalError}>
                    <ModalBody>
                        <h4 className="h5 text-center-py-4">Esta obra social no se puede eliminar porque está vinculada con pacientes cargados en el sistema<br /></h4>
